...
NLP Movie Review Sentimental Analyzer: 
- Use Transfer learning to apply a pre-trained NLP model from hugging-face


This project will accept text input of a movie review 
